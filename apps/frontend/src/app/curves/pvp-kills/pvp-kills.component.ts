...
@Component({
  selector: 'division-loader-pvp-kills',
  templateUrl: './pvp-kills.component.html',
  styleUrls: ['./pvp-kills.component.scss'],
})
export class PvpKillsComponent {
  private _currentStatsSubscription: Subscription | undefined;

  characters: CharacterStats[] = [];
  graphType = GraphTypeKey.PVP_KILLS;
